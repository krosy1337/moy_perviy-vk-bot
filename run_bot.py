...
def masaga(slovko, gaga,gaga2,gaga3,user_id, photo, messag, user_idb , photob, messagb, user_idc, photoc, messagc):
    if slovo == slovko:
        if gaga == 'a':
            send_photo(user_id, photo, messag )
        elif gaga2 == 'b':
            send_photo(user_idb, photob, messagb)
        elif gaga3 == 'c':
            send_photo(user_idc, photoc, messagc)
    ...
    try:
        ...
        if update[0][0] == 4:
            ...
            if "прив" in upd:  # Если нам пишут привет
                ...
                masaga('a', upd, upd, upd, user_id, 'photo-174113882_456239138', 'Ты в комнате AA',
                       user_id, 'photo-174113882_456239139', 'Ты в комнате AB',
                       user_id, 'photo-174113882_456239147', 'Ты в комнате AC')
                masaga('b', upd, upd, upd, user_id, 'photo-174113882_456239150', 'Ты в комнате BA',
                       user_id, 'photo-174113882_456239151', 'Ты в комнате BB',
                       user_id, 'photo-174113882_456239152', 'Ты в комнате BC')
                masaga('c', upd, upd, upd, user_id, 'photo-174113882_456239156', 'Ты в комнате CA',
                ...
                if upd == 'назад':
                    ...
                    masaga('b', slovo2, slovo2, slovo2, user_id, 'photo-174113882_456239150', 'Ты в комнате BA',
                           user_id, 'photo-174113882_456239151', 'Ты в комнате BB',
                           user_id, 'photo-174113882_456239152', 'Ты в комнате BC')
                    masaga('c', slovo2, slovo2, slovo2, user_id, 'photo-174113882_456239156', 'Ты в комнате CA',
                           user_id, 'photo-174113882_456239155', 'Ты в комнате CB',
                           user_id, '', '')
                    # elif slovo == 'b':
                    #     if slovo2 == 'a':
